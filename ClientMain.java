...
public class ClientMain {
    ...
    private static ConcurrentClient[] threads;
    ...
    private static void generateThreads(int threadCount, String command, String myHost) {
        threads = new ConcurrentClient[threadCount];
        
        for (int i = 0; i < threadCount; i++) {
            threads[i] = new ConcurrentClient(command, myHost);
        }
    }
    ...
    private static void getResults(int threadCount) {
        ...
        for(ConcurrentClient t : threads) {
    ...
    private static void signalServerExit() {
        ...
        try {
            // Signal Server End
            Socket socket = new Socket(myHost, ConcurrentClient.portNumber);
